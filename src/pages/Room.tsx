...
import leaveRoom from '../assets/images/leave.png'
      ...
      <header className={theme}>
        <div className="content">
            ...
            <div>
              ...
              <Button isOutlined onClick={handleLeaveRoom}>
                <img src={leaveRoom} alt="Sair da sala" width="20px" height="20px" />
                Sair da sala
              </Button>
            </div>
        ...
        <form onSubmit={handleSendQuestion}>
          ...
          <div className="form-footer">
            { user ? (
              ...
              <span>Para enviar uma pergunta, <button onClick={handleMakeLogin}>faça seu login</button></span>
            ) }
